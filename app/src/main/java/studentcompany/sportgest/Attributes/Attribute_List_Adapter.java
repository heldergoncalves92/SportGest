...
public class Attribute_List_Adapter extends RecyclerView.Adapter<Attribute_List_Adapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private Attribute_List_Adapter su = null;
        public AppCompatTextView mTextView_name;
        public CardView parent;


        public ViewHolder(View view, Attribute_List_Adapter su) {
            super(view);
    ...
    public Attribute_List_Adapter(List<Attribute> myDataset, Attribute_Fragment_List.OnItemSelected mListener, int tag) {
    ...
    @Override
    public Attribute_List_Adapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                             int viewType) {
        // create a new view
