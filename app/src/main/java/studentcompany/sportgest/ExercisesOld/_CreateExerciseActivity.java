...
public class _CreateExerciseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout._activity_create_exercise);
        ...
        if(extras !=null) {
            ...
            if (exerciseID > 0) {
                try {
                    ...
                    System.err.println(_CreateExerciseActivity.class.getName() + " [WARNING] " + ex.toString());
                    Logger.getLogger(_CreateExerciseActivity.class.getName()).log(Level.WARNING, null, ex);
                    exercise = null;
                }
                ...
                if (exercise != null) {
                    ...
                    try {
                        ...
                        System.err.println(_ListExerciseActivity.class.getName() + " [WARNING] " + ex.toString());
                        Logger.getLogger(_ListExerciseActivity.class.getName()).log(Level.WARNING, null, ex);
