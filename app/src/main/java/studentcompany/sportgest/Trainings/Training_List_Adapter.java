...
public class Training_List_Adapter extends RecyclerView.Adapter<Training_List_Adapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private Training_List_Adapter su = null;
        public AppCompatTextView mTextView_name;
        public CardView parent;


        public ViewHolder(View view, Training_List_Adapter su) {
            super(view);
    ...
    public Training_List_Adapter(List<Training> myDataset, Training_Fragment_List.OnItemSelected mListener, int tag) {
    ...
    @Override
    public Training_List_Adapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                             int viewType) {
        // create a new view
