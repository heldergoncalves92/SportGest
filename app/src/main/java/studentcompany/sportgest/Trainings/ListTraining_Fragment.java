...
public class ListTraining_Fragment extends ListFragment {
    ...
    public void onActivityCreated(Bundle savedState){
        ...
        if(list != null)
            setListAdapter(new ArrayAdapter<String>(getActivity(), R.layout.fragment_training_list, list));

        // Set the list choice mode to allow only one selection at a time
        getListView().setChoiceMode(ListView.CHOICE_MODE_SINGLE);
    }

    public void setTrainingList(List<String> list){
        this.list = list;
    }
